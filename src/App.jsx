...
const S = {
  ...
  AZ:{name:"Arizona",status:"legal_online",statusLabel:"Legal – Online & Retail",channels:"Online + Retail",legalMethod:"Legislature (HB 2772)",yearLegalized:2021,yearLaunched:2021,taxRate:"10% online / 8% retail",handle2025:"$7.6B",regulator:"AZ Dept. of Gaming",operators:["DraftKings","FanDuel","BetMGM","Caesars","bet365","Fanatics","BetRivers","ESPN Bet","SuperBook","Betfred"],collegeBetting:"All teams allowed",collegeProps:"Banned (team & player)",restrictions:"Up to 20 licenses (18 issued). Both tribal and commercial operators.",sources:[{label:"AZ Dept. of Gaming",url:"https://gaming.az.gov/"},{label:"Tax Foundation 2025",url:"https://taxfoundation.org/data/all/state/online-sports-betting-taxes/"}]},
  AR:{name:"Arkansas",status:"legal_online",statusLabel:"Legal – Online & Retail",channels:"Online + Retail",legalMethod:"Ballot (Issue 4, 2018)",yearLegalized:2018,yearLaunched:2019,taxRate:"13% (first $150M) / 20% (above)",handle2025:"$0.6B",regulator:"AR Racing Commission",operators:["DraftKings","FanDuel","BETSaracen"],collegeBetting:"No restrictions",collegeProps:"Allowed",restrictions:"51-49% revenue split favoring in-state casinos. Tax is 13% on first $150M net casino revenue per fiscal year, 20% above that.",sources:[{label:"SportsHandle",url:"https://sportshandle.com/sports-betting-revenue/"},{label:"BettingUSA",url:"https://www.bettingusa.com/sports/taxes-and-licenses/"}]},
  ...
  CO:{name:"Colorado",status:"legal_online",statusLabel:"Legal – Online & Retail",channels:"Online + Retail",legalMethod:"Ballot (Nov 2019)",yearLegalized:2019,yearLaunched:2020,taxRate:"10%",handle2025:"$6.8B",regulator:"CO Div. of Gaming",operators:["DraftKings","FanDuel","BetMGM","Caesars","BetRivers","bet365","Fanatics","SuperBook","Circa","Betfred"],collegeBetting:"All teams allowed",collegeProps:"Banned",restrictions:"Statutory 10% rate; effective rate has been ~5.4% due to promo deductions, but promo write-offs are being phased out and fully sunset by July 2026. 33 casinos eligible.",sources:[{label:"Tax Foundation 2025",url:"https://taxfoundation.org/data/all/state/online-sports-betting-taxes/"},{label:"BettingUSA",url:"https://www.bettingusa.com/sports/taxes-and-licenses/"}]},
  CT:{name:"Connecticut",status:"legal_online",statusLabel:"Legal – Online & Retail",channels:"Online + Retail",legalMethod:"Legislature + Tribal compact",yearLegalized:2021,yearLaunched:2021,taxRate:"13.75%",handle2025:"$2.2B",regulator:"CT Dept. of Consumer Protection",operators:["DraftKings","FanDuel","Fanatics"],collegeBetting:"No in-state teams (except tournaments)",collegeProps:"Follows in-state ban",restrictions:"Hybrid: tribal casinos + lottery. Must partner with master gaming operator.",sources:[{label:"Tax Foundation 2025",url:"https://taxfoundation.org/data/all/state/online-sports-betting-taxes/"}]},
  DE:{name:"Delaware",status:"legal_online",statusLabel:"Legal – Online & Retail",channels:"Online + Retail",legalMethod:"Existing law (grandfathered)",yearLegalized:2018,yearLaunched:2018,taxRate:"50%",handle2025:"$0.3B",regulator:"DE Lottery",operators:["BetRivers"],collegeBetting:"No in-state teams",collegeProps:"Follows in-state ban",restrictions:"First state outside NV to accept single-game bet (June 2018). Online via BetRivers since Jan 2024.",sources:[{label:"SportsHandle",url:"https://sportshandle.com/sports-betting-revenue/"}]},
  DC:{name:"Washington D.C.",status:"legal_online",statusLabel:"Legal – Online & Retail",channels:"Online + Retail",legalMethod:"DC Council",yearLegalized:2018,yearLaunched:2020,taxRate:"30%",handle2025:"$0.4B",regulator:"DC Office of Lottery & Gaming",operators:["GambetDC","Caesars","BetMGM"],collegeBetting:"No DC teams or events",collegeProps:"Follows restrictions",restrictions:"Two-tier: lottery app (GambetDC) citywide; private operators geofenced to venues. Tax rate set to 30% on most online sports betting since Aug 2024.",sources:[{label:"Tax Foundation 2025",url:"https://taxfoundation.org/data/all/state/online-sports-betting-taxes/"}]},
  FL:{name:"Florida",status:"legal_online",statusLabel:"Legal – Tribal Monopoly",channels:"Online + Retail (tribal)",legalMethod:"Tribal compact (2021)",yearLegalized:2021,yearLaunched:2023,taxRate:"Revenue-share",handle2025:"$5.0B",regulator:"Seminole Tribe / FL Gaming Commission",operators:["Hard Rock Bet"],collegeBetting:"All teams allowed",collegeProps:"Banned",restrictions:"Hard Rock Bet sole mobile operator. Relaunched Dec 2023.",sources:[{label:"OddsMatrix",url:"https://oddsmatrix.com/legal-sports-betting/"}]},
  ...
  IL:{name:"Illinois",status:"legal_online",statusLabel:"Legal – Online & Retail",channels:"Online + Retail",legalMethod:"Legislature",yearLegalized:2019,yearLaunched:2020,taxRate:"Graduated 20–40% + per-wager fee",handle2025:"$15.5B",regulator:"IL Gaming Board",operators:["DraftKings","FanDuel","BetMGM","Caesars","BetRivers","Fanatics","ESPN Bet","bet365","Hard Rock Bet"],collegeBetting:"No in-state teams (since July 2024)",collegeProps:"Banned",restrictions:"Tax hiked to graduated 20–40%. Chicago adds 2%. Per-wager fee: $0.25 on first 20M wagers, $0.50 beyond (eff. July 2025).",sources:[{label:"Tax Foundation 2025",url:"https://taxfoundation.org/data/all/state/online-sports-betting-taxes/"},{label:"BettingUSA",url:"https://www.bettingusa.com/sports/taxes-and-licenses/"}]},
  IN:{name:"Indiana",status:"legal_online",statusLabel:"Legal – Online & Retail",channels:"Online + Retail",legalMethod:"Legislature",yearLegalized:2019,yearLaunched:2019,taxRate:"9.5%",handle2025:"$4.5B",regulator:"IN Gaming Commission",operators:["DraftKings","FanDuel","BetMGM","Caesars","BetRivers","Fanatics","bet365","Hard Rock Bet"],collegeBetting:"All teams allowed",collegeProps:"Pre-game only (no live)",restrictions:"No live in-play college player props. D-I only.",sources:[{label:"Tax Foundation 2025",url:"https://taxfoundation.org/data/all/state/online-sports-betting-taxes/"}]},
  IA:{name:"Iowa",status:"legal_online",statusLabel:"Legal – Online & Retail",channels:"Online + Retail",legalMethod:"Legislature",yearLegalized:2019,yearLaunched:2019,taxRate:"6.75%",handle2025:"$2.5B",regulator:"IA Racing & Gaming Commission",operators:["DraftKings","FanDuel","BetMGM","Caesars","BetRivers","bet365","Q Sportsbook"],collegeBetting:"All teams allowed",collegeProps:"No props on in-state athletes",restrictions:"Lowest tax rate (tied NV). In-person registration removed 2021.",sources:[{label:"Tax Foundation 2025",url:"https://taxfoundation.org/data/all/state/online-sports-betting-taxes/"}]},
  KS:{name:"Kansas",status:"legal_online",statusLabel:"Legal – Online & Retail",channels:"Online + Retail",legalMethod:"Legislature",yearLegalized:2022,yearLaunched:2022,taxRate:"10%",handle2025:"$1.8B",regulator:"KS Racing & Gaming Commission",operators:["DraftKings","FanDuel","BetMGM","Caesars","BetRivers","Fanatics"],collegeBetting:"No restrictions",collegeProps:"Allowed",restrictions:"Up to 6 mobile operators.",sources:[{label:"OddsMatrix",url:"https://oddsmatrix.com/legal-sports-betting/"}]},
  KY:{name:"Kentucky",status:"legal_online",statusLabel:"Legal – Online & Retail",channels:"Online + Retail",legalMethod:"Legislature (HB 606)",yearLegalized:2023,yearLaunched:2023,taxRate:"14.25%",handle2025:"$3.2B",regulator:"KY Horse Racing Commission",operators:["DraftKings","FanDuel","BetMGM","Caesars","bet365","Fanatics"],collegeBetting:"No restrictions",collegeProps:"Allowed (HB 904 pending)",restrictions:"HB 904 (2026) would ban in-state athlete props & raise age to 21.",sources:[{label:"BettorsInsider",url:"https://bettorsinsider.com/news/2026/03/23/prop-bet-bans-are-coming-louisiana-kentucky-minnesota-target-college-player-props/"}]},
  LA:{name:"Louisiana",status:"legal_online",statusLabel:"Legal – Online & Retail",channels:"Online + Retail",legalMethod:"Legislature + parish vote",yearLegalized:2020,yearLaunched:2022,taxRate:"21.5%",handle2025:"$4.1B",regulator:"LA Gaming Control Board",operators:["DraftKings","FanDuel","BetMGM","Caesars","BetRivers","Fanatics","bet365"],collegeBetting:"All teams allowed",collegeProps:"Banned (Aug 2024)",restrictions:"55/64 parishes voted yes. Tax increased to 21.5% in 2025.",sources:[{label:"Tax Foundation 2025",url:"https://taxfoundation.org/data/all/state/online-sports-betting-taxes/"}]},
  ME:{name:"Maine",status:"legal_online",statusLabel:"Legal – Online & Retail",channels:"Online + Retail",legalMethod:"Legislature",yearLegalized:2022,yearLaunched:2023,taxRate:"10%",handle2025:"$0.4B",regulator:"ME Gambling Control Unit",operators:["DraftKings","FanDuel","Caesars","BetMGM"],collegeBetting:"No in-state teams (incl. tournaments)",collegeProps:"Follows in-state ban",restrictions:"Online sweepstakes & credit card funding banned 2026.",sources:[{label:"BMR",url:"https://www.bookmakersreview.com/industry/maine-online-gambling-laws-2026/"}]},
  MD:{name:"Maryland",status:"legal_online",statusLabel:"Legal – Online & Retail",channels:"Online + Retail",legalMethod:"Ballot (2020) + Legislature",yearLegalized:2020,yearLaunched:2022,taxRate:"20%",handle2025:"$6.5B",regulator:"MD Lottery & Gaming",operators:["DraftKings","FanDuel","BetMGM","Caesars","BetRivers","Fanatics","bet365","Hard Rock Bet","ESPN Bet"],collegeBetting:"All teams allowed",collegeProps:"Banned (March 2024)",restrictions:"Tax rate increased to 20% in 2025.",sources:[{label:"Tax Foundation 2025",url:"https://taxfoundation.org/data/all/state/online-sports-betting-taxes/"}]},
  MA:{name:"Massachusetts",status:"legal_online",statusLabel:"Legal – Online & Retail",channels:"Online + Retail",legalMethod:"Legislature",yearLegalized:2022,yearLaunched:2023,taxRate:"20%",handle2025:"$8.4B",regulator:"MA Gaming Commission",operators:["DraftKings","FanDuel","BetMGM","Caesars","ESPN Bet","Fanatics","bet365"],collegeBetting:"No in-state (except tournaments)",collegeProps:"Banned",restrictions:"$5M license fee. Reopening new licenses Apr 2026.",sources:[{label:"BMR",url:"https://www.bookmakersreview.com/industry/massachusetts-reopens-sports-betting-licenses/"}]},
  MI:{name:"Michigan",status:"legal_online",statusLabel:"Legal – Online & Retail",channels:"Online + Retail",legalMethod:"Legislature",yearLegalized:2019,yearLaunched:2021,taxRate:"8.4%",handle2025:"$5.4B",regulator:"MI Gaming Control Board",operators:["DraftKings","FanDuel","BetMGM","Caesars","BetRivers","Fanatics","bet365","WynnBet"],collegeBetting:"No restrictions",collegeProps:"Allowed",restrictions:"One of most open markets. Also has iGaming. Targeting offshore books 2026.",sources:[{label:"Tax Foundation 2025",url:"https://taxfoundation.org/data/all/state/online-sports-betting-taxes/"}]},
  ...
  OR:{name:"Oregon",status:"legal_online",statusLabel:"Legal – Online (Lottery)",channels:"Online (lottery-run)",legalMethod:"Existing law (grandfathered)",yearLegalized:2019,yearLaunched:2019,taxRate:"51% (lottery)",handle2025:"$1.2B",regulator:"OR Lottery",operators:["DraftKings (exclusive)"],collegeBetting:"Banned on state platform",collegeProps:"Banned on state platform",restrictions:"OR Lottery bans all college sports betting on the DraftKings state platform. Tribal retail casinos may accept college wagers under separate authority. DraftKings is sole mobile operator.",sources:[{label:"Bleacher Nation",url:"https://www.bleachernation.com/betting/2026/03/05/college-player-props/"}]},
  PA:{name:"Pennsylvania",status:"legal_online",statusLabel:"Legal – Online & Retail",channels:"Online + Retail",legalMethod:"Legislature",yearLegalized:2017,yearLaunched:2018,taxRate:"36%",handle2025:"$9.2B",regulator:"PA Gaming Control Board",operators:["DraftKings","FanDuel","BetMGM","Caesars","BetRivers","Fanatics","bet365","Unibet","BetParx","Betway"],collegeBetting:"All teams incl. in-state",collegeProps:"Banned",restrictions:"$10M license fee. Effective rate ~24.6% after promo deductions.",sources:[{label:"Tax Foundation 2025",url:"https://taxfoundation.org/data/all/state/online-sports-betting-taxes/"},{label:"BettingUSA",url:"https://www.bettingusa.com/sports/taxes-and-licenses/"}]},
  RI:{name:"Rhode Island",status:"legal_online",statusLabel:"Legal – Online & Retail",channels:"Online + Retail",legalMethod:"Legislature",yearLegalized:2018,yearLaunched:2018,taxRate:"51%",handle2025:"$0.5B",regulator:"RI Dept. of Business Regulation",operators:["Bally Bet"],collegeBetting:"No in-state teams/events",collegeProps:"Follows in-state ban",restrictions:"51% tax. Small market.",sources:[{label:"Tax Foundation 2025",url:"https://taxfoundation.org/data/all/state/online-sports-betting-taxes/"}]},
  SC:{name:"South Carolina",status:"not_legal",statusLabel:"Not Legal",channels:"—",legalMethod:"—",yearLegalized:null,yearLaunched:null,taxRate:"—",handle2025:"—",regulator:"—",operators:[],collegeBetting:"—",collegeProps:"—",restrictions:"No active legislation.",sources:[{label:"BMR",url:"https://www.bookmakersreview.com/usa/"}]},
  SD:{name:"South Dakota",status:"legal_retail",statusLabel:"Legal – Retail (Deadwood + Tribal)",channels:"Retail only",legalMethod:"Ballot (Nov 2020)",yearLegalized:2020,yearLaunched:2021,taxRate:"9%",handle2025:"—",regulator:"SD Commission on Gaming",operators:["Deadwood sportsbooks","Tribal sportsbooks"],collegeBetting:"No in-state teams",collegeProps:"Banned",restrictions:"Deadwood + tribal only. 2026 mobile ballot possible.",sources:[{label:"SportsHandle",url:"https://sportshandle.com/sports-betting-revenue/"}]},
  TN:{name:"Tennessee",status:"legal_online",statusLabel:"Legal – Online Only",channels:"Online only",legalMethod:"Legislature (HB 1)",yearLegalized:2019,yearLaunched:2020,taxRate:"1.85% on handle (~20% GGR)",handle2025:"$5.3B",regulator:"TN Sports Wagering Advisory Council",operators:["DraftKings","FanDuel","BetMGM","Caesars","ESPN Bet","Fanatics","Hard Rock Bet","bet365"],collegeBetting:"In-state allowed",collegeProps:"Banned (+ no in-play team props)",restrictions:"Online-only. First state to tax on handle instead of GGR.",sources:[{label:"BettingUSA",url:"https://www.bettingusa.com/sports/taxes-and-licenses/"}]},
  ...
  VT:{name:"Vermont",status:"legal_online",statusLabel:"Legal – Online Only",channels:"Online only",legalMethod:"Legislature",yearLegalized:2023,yearLaunched:2024,taxRate:"≥20% rev share",handle2025:"$0.3B",regulator:"VT Dept. of Liquor & Lottery",operators:["DraftKings","FanDuel","Fanatics"],collegeBetting:"No in-state (except tournaments)",collegeProps:"Banned",restrictions:"$550K fee. Operators committed above 20% minimum.",sources:[{label:"Withum",url:"https://www.withum.com/resources/how-states-tax-sports-betting-a-comparative-analysis/"}]},
  VA:{name:"Virginia",status:"legal_online",statusLabel:"Legal – Online & Retail",channels:"Online + Retail",legalMethod:"Legislature",yearLegalized:2020,yearLaunched:2021,taxRate:"15%",handle2025:"$6.2B",regulator:"VA Lottery Board",operators:["DraftKings","FanDuel","BetMGM","Caesars","BetRivers","Fanatics","bet365","Hard Rock Bet"],collegeBetting:"No in-state teams",collegeProps:"Banned (all college)",restrictions:"Multiple attempts to reverse in-state ban have failed.",sources:[{label:"Tax Foundation 2025",url:"https://taxfoundation.org/data/all/state/online-sports-betting-taxes/"}]},
  WA:{name:"Washington",status:"legal_retail",statusLabel:"Legal – Tribal Only",channels:"Tribal casinos only",legalMethod:"Legislature + Tribal compact",yearLegalized:2020,yearLaunched:2021,taxRate:"N/A (tribal)",handle2025:"—",regulator:"WA Gambling Commission",operators:["Various tribal sportsbooks"],collegeBetting:"No in-state teams",collegeProps:"Banned",restrictions:"SB 6137 (2026) passed Senate 41-8 to allow in-state college bets with player prop ban.",sources:[{label:"OddsShark",url:"https://www.oddsshark.com/industry-news/washington-bill-allowing-college-betting-ban-props"}]},
  WV:{name:"West Virginia",status:"legal_online",statusLabel:"Legal – Online & Retail",channels:"Online + Retail",legalMethod:"Legislature",yearLegalized:2018,yearLaunched:2018,taxRate:"10%",handle2025:"$0.9B",regulator:"WV Lottery Commission",operators:["DraftKings","FanDuel","BetMGM","Caesars","BetRivers","Fanatics"],collegeBetting:"No restrictions",collegeProps:"Allowed",restrictions:"10% tax, no promo deductions. Also has iGaming.",sources:[{label:"BettingUSA",url:"https://www.bettingusa.com/sports/taxes-and-licenses/"}]},
  ...
  WY:{name:"Wyoming",status:"legal_online",statusLabel:"Legal – Online Only",channels:"Online only",legalMethod:"Legislature",yearLegalized:2021,yearLaunched:2021,taxRate:"10%",handle2025:"$0.3B",regulator:"WY Gaming Commission",operators:["DraftKings","FanDuel","BetMGM","Caesars"],collegeBetting:"No restrictions",collegeProps:"Allowed",restrictions:"Online-only. Small but growing market.",sources:[{label:"Tax Foundation 2025",url:"https://taxfoundation.org/data/all/state/online-sports-betting-taxes/"}]},
};
...
export default function App() {
  ...
  const csvDataUri = useMemo(() => {
    const headers = ["State","Abbr","Status","Channels","Legal Method","Year Legalized","Year Launched","Tax Rate","2025 Handle","Regulator","Operators","College Betting","College Props","Restrictions","Sources"];
    const esc = v => { const s = String(v ?? "—"); return s.includes(",") || s.includes('"') || s.includes("\n") ? '"' + s.replace(/"/g, '""') + '"' : s; };
    const rows = Object.entries(S).map(([abbr, s]) => [
      s.name, abbr, s.statusLabel, s.channels, s.legalMethod,
      s.yearLegalized || "—", s.yearLaunched || "—", s.taxRate, s.handle2025, s.regulator,
              ...
              {det ? (
                <div style={{background:"#161b22",border:"1px solid #30363d",borderRadius:12,padding:20}}>
                  ...
                  <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"12px 16px",fontSize:13}}>
                    ...
                    <F l="2025 Handle" v={det.handle2025}/><F l="College Betting" v={det.collegeBetting}/>
                    <F l="College Props" v={det.collegeProps}/>
                  </div>
                ...
                return (
                  <React.Fragment key={s.abbr}>
                    <tr onClick={()=>setSel(isExp?null:s.abbr)} style={{background:i%2?"#161b22":"#0d1117",cursor:"pointer",borderBottom:isExp?"none":"1px solid #21262d"}}>
                      ...
                      <td style={{padding:"7px 10px",color:"#c9d1d9",fontSize:10}}>{s.handle2025}</td>
                    ...
                    {isExp && (
                      <tr style={{background:"#161b22"}}>
                        <td colSpan={7} style={{padding:"12px 16px 16px",borderBottom:"2px solid #30363d"}}>
