...
const S = {
  ...
  AR:{name:"Arkansas",status:"legal_online",statusLabel:"Legal – Online & Retail",channels:"Online + Retail",legalMethod:"Ballot (Issue 4, 2018)",yearLegalized:2018,yearLaunched:2019,taxRate:"13%–20%",regulator:"AR Racing Commission",operators:["DraftKings","FanDuel","BETSaracen"],collegeBetting:"No restrictions",collegeProps:"Allowed",restrictions:"51-49% revenue split favoring in-state casinos.",sources:[{label:"SportsHandle",url:"https://sportshandle.com/sports-betting-revenue/"}]},
  ...
  CO:{name:"Colorado",status:"legal_online",statusLabel:"Legal – Online & Retail",channels:"Online + Retail",legalMethod:"Ballot (Nov 2019)",yearLegalized:2019,yearLaunched:2020,taxRate:"10%",regulator:"CO Div. of Gaming",operators:["DraftKings","FanDuel","BetMGM","Caesars","BetRivers","bet365","Fanatics","SuperBook","Circa","Betfred"],collegeBetting:"All teams allowed",collegeProps:"Banned",restrictions:"Effective tax rate ~5.4% after promo deductions. 33 casinos eligible.",sources:[{label:"Tax Foundation 2025",url:"https://taxfoundation.org/data/all/state/online-sports-betting-taxes/"},{label:"BettingUSA",url:"https://www.bettingusa.com/sports/taxes-and-licenses/"}]},
  ...
  DC:{name:"Washington D.C.",status:"legal_online",statusLabel:"Legal – Online & Retail",channels:"Online + Retail",legalMethod:"DC Council",yearLegalized:2018,yearLaunched:2020,taxRate:"20–30%",regulator:"DC Office of Lottery & Gaming",operators:["GambetDC","Caesars","BetMGM"],collegeBetting:"No DC teams or events",collegeProps:"Follows restrictions",restrictions:"Two-tier: lottery app citywide; private operators geofenced to venues. Tax to 30% in 2024.",sources:[{label:"Tax Foundation 2025",url:"https://taxfoundation.org/data/all/state/online-sports-betting-taxes/"}]},
  ...
  MO:{name:"Missouri",status:"legal_online",statusLabel:"Legal – Online & Retail (Dec 2025)",channels:"Online + Retail",legalMethod:"Ballot (Nov 2024)",yearLegalized:2024,yearLaunched:2025,taxRate:"10%",regulator:"MO Gaming Commission",operators:["Licensing in progress"],collegeBetting:"TBD (MGC finalizing)",collegeProps:"TBD",restrictions:"39th state live (Dec 1, 2025). Full licensing expected mid-2026.",sources:[{label:"AP News",url:"https://apnews.com/article/sports-betting-prop-bets-missouri-f7be83cb51fb9be828089f005f83075e"}]},
  ...
  NJ:{name:"New Jersey",status:"legal_online",statusLabel:"Legal – Online & Retail",channels:"Online + Retail",legalMethod:"Legislature (post-Murphy v. NCAA)",yearLegalized:2018,yearLaunched:2018,taxRate:"21% online / 19.75% retail",regulator:"NJ Div. of Gaming Enforcement",operators:["DraftKings","FanDuel","BetMGM","Caesars","BetRivers","Fanatics","bet365","Unibet","Hard Rock Bet","Resorts Digital"],collegeBetting:"No in-state teams/events",collegeProps:"Allowed (outside in-state)",restrictions:"Pioneer state. Must partner with brick-and-mortar. Tax increased to 21% in 2025.",sources:[{label:"Tax Foundation 2025",url:"https://taxfoundation.org/data/all/state/online-sports-betting-taxes/"},{label:"BettingUSA",url:"https://www.bettingusa.com/sports/taxes-and-licenses/"}]},
  ...
  ND:{name:"North Dakota",status:"legal_retail",statusLabel:"Legal – Tribal Only",channels:"Tribal casinos only",legalMethod:"Tribal compact",yearLegalized:null,yearLaunched:null,taxRate:"N/A (tribal)",regulator:"Tribal authorities",operators:["Tribal sportsbooks"],collegeBetting:"Varies by operator",collegeProps:"Varies",restrictions:"Tribal-only. 2025 online ballot proposal rejected.",sources:[{label:"PokerScout",url:"https://www.pokerscout.com/guides/sports-betting-state-tracker/"}]},
  ...
  OR:{name:"Oregon",status:"legal_online",statusLabel:"Legal – Online (Lottery)",channels:"Online (lottery-run)",legalMethod:"Existing law (grandfathered)",yearLegalized:2019,yearLaunched:2019,taxRate:"51% (lottery)",regulator:"OR Lottery",operators:["DraftKings (exclusive)"],collegeBetting:"BANNED entirely",collegeProps:"BANNED (no college at all)",restrictions:"Only state banning ALL college sports betting. DraftKings sole operator.",sources:[{label:"Bleacher Nation",url:"https://www.bleachernation.com/betting/2026/03/05/college-player-props/"}]},
    ...
    <div style={{fontFamily:"'Crimson Pro',Georgia,serif",background:"#0d1117",color:"#e6edf3",minHeight:"100vh"}}>
      ...
      <div style={{maxWidth:1200,margin:"0 auto",padding:"20px 24px"}}>
        ...
        <div style={{marginTop:28,padding:18,background:"#161b22",border:"1px solid #30363d",borderRadius:12,fontSize:11,color:"#7c8594",fontFamily:m,lineHeight:1.7}}>
          ...
          <p style={{margin:"0 0 6px"}}>Tax rates are for online/mobile unless noted. Effective rates may differ due to promo deductions. Operator lists are major licensees, not exhaustive. Missouri rules being finalized.</p>
